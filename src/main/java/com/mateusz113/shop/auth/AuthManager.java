...
public class AuthManager {
    public User registerUser(RegisterDetails registerDetails, UserFileWriter writer, UserFileReader reader) throws UserAlreadyExistsException, IOException {
    ...
    public User loginUser(LoginDetails loginDetails, UserFileReader reader) throws IOException, NoSuchUserException {
        String userId = getIdFromLoginDetails(loginDetails, reader);
        return getUserFromId(userId, reader);
    }

    private String getIdFromLoginDetails(LoginDetails loginDetails, UserFileReader reader) throws IOException, NoSuchUserException {
    ...
    private User getUserFromId(String id, UserFileReader reader) throws IOException, NoSuchUserException {
